...
public class TesteJavaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teste_java);

        btQuestao1a = findViewById(R.id.btTesteJava1A);
        btQuestao1b = findViewById(R.id.btTesteJava1B);
        btQuestao1c = findViewById(R.id.btTesteJava1C);
        btQuestao1d = findViewById(R.id.btTesteJava1D);



        tvQuestaoNum = findViewById(R.id.tvQuestaoJavaNum);
        tvQuestaoTexto = findViewById(R.id.tvQuestaoJavaTexto);

        btVerificar = findViewById(R.id.btVerificarJava);

        main = findViewById(R.id.main);
        carregarPerguntas();

        Global.acertosJava = 0;
        Global.errosJava = 0;
    ...
    private void carregarPerguntas(){
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.perguntasjava);
            ...
            Toast.makeText(TesteJavaActivity.this, "Erro", Toast.LENGTH_SHORT).show();
        }
    ...
    private void proxPergunta(){
        if (!linhas.isEmpty()){
            if (numQuestao < 10){
                ...
                Toast.makeText(TesteJavaActivity.this, "Teste Terminado", Toast.LENGTH_SHORT).show();
                Toast.makeText(TesteJavaActivity.this, "Total de acertos: " + Global.acertosJava, Toast.LENGTH_SHORT).show();
                Toast.makeText(TesteJavaActivity.this, "Total de erros: " + Global.errosJava, Toast.LENGTH_SHORT).show();

                if (Global.acertosJava - Global.errosJava * 0.2 < 0){
                ...
                ResultadoTesteActivity.quantErros = Global.errosJava;
    ...
    private void verificarResp(String repostaEsc) {
        if (repostaEsc.equals(respCerta)) {
            Toast.makeText(TesteJavaActivity.this, "Acertou!", Toast.LENGTH_SHORT).show();
            btVerificar.setBackgroundColor(parseColor("#80ff00"));
            btSelecionado.setBackgroundColor(parseColor("#80ff00"));

            Global.acertosJava++;
        } else {
            Toast.makeText(TesteJavaActivity.this, "Errou!", Toast.LENGTH_SHORT).show();
